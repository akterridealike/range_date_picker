...
class _RangePickerPageState extends State<RangePickerPage> {
  ...
  final DateTime _firstDate = DateTime.now().subtract(Duration(days: 10));
  final DateTime _lastDate = DateTime.now().add(Duration(days: 2));

  DatePeriod _selectedPeriod = DatePeriod(DateTime.now().subtract(Duration(days: 3)), DateTime.now().
  add(Duration(days: 1)));
  ...
  //    time = int.tryParse(DateFormat('HH').format(now));
  //    print(time);
  //
  // }
  @override
            ...
            child: Column(
              ...
              children: <Widget>[
                Slider(
                    value:sliderIndex ,
                    onChanged: (val) {
                      print("oht of set$val");
                      // if(sliderIndex+time>23.00){
                      //   _lastDate.add(Duration(days: 1));
                      //   _selectedPeriod.end.add(Duration(days: 1));
                      //   print("print from onchange");
                      // }

                      setState(() {
                        sliderIndex = val ;
                        print("inside of set$val");
